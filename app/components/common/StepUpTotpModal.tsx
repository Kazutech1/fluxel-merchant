        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            <div className="relative">
              <KeyRound className="w-4 h-4 absolute left-3 top-3 text-slate-400 dark:text-slate-500" />
              <input
                type="text"
                maxLength={6}
                value={totpCode}
                ...
                placeholder="123456"
                className="w-full pl-10 pr-4 py-2.5 bg-slate-50 dark:bg-[#1c1c20] border border-slate-300 dark:border-slate-800 rounded-lg text-slate-900 dark:text-white font-mono tracking-widest text-lg font-bold text-center focus:ring-2 focus:ring-amber-400 dark:focus:ring-[#fed700] fast-transition outline-none"
                autoFocus
              />
            </div>
