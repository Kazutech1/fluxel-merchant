    ...
    <div className="space-y-6 animate-in fade-in duration-150 max-w-2xl mx-auto">
      <div className="bg-white border border-slate-200 rounded-xl p-6 shadow-xs space-y-6">
        <div className="flex items-center gap-3 pb-4 border-b border-slate-200">
          ...
          <div>
            <h3 className="text-lg font-bold text-slate-900">Internal Customer-to-Customer Transfer</h3>
            <p className="text-xs text-slate-500 font-medium">Instant Double-Entry Ledger Posting · Zero Network Fees</p>
          </div>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="pt-4 border-t border-slate-100">
            <button
              ...
              className="w-full py-3 bg-indigo-600 hover:bg-indigo-700 disabled:bg-slate-300 text-white rounded-lg text-xs font-bold uppercase tracking-wider shadow-xs hover:shadow flex items-center justify-center gap-2 fast-transition cursor-pointer"
            >
